...
export interface Option {
  value: string;
  label: string;
  leftDecorator?: React.JSX.Element;
  disable?: boolean;
  /** fixed option that can't be removed. */
  fixed?: boolean;
  /** Group the options by providing key. */
  [key: string]: string | boolean |  React.JSX.Element | undefined;
}
    ...
    return (
      ...
      >
            ...
            {selected.map((option) => {
              return (
                ...
                >
                  ...
                  <button
                    aria-label="Remove"
                    className="absolute -inset-y-px flex justify-center items-center p-0 border border-transparent rounded-e-lg focus-visible:outline-ring/70 text-muted-foreground/80 hover:text-foreground transition-colors -end-px focus-visible:outline focus-visible:outline-2 outline-0 size-7"
        ...
        <div className="relative">
          ...
          >
            {open ? <CommandList
                className="bg-popover shadow-black/5 shadow-lg text-popover-foreground outline-none"
                onMouseEnter={() => {
                  setOnScrollbar(true);
                }}
                onMouseLeave={() => {
