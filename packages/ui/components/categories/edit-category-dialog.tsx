import { UpdateCategoryDocument } from "gql-generated/gql/graphql";
import type {
  Category,
  GetCategoryQuery,
...
export const EditCategoryDialog = ({
  ...
  const onUpdateCategory = async (formData: FormData) => {
    try {
      setIsUpdating(true)
      const result = await updateCategoryMutation({
        updateCategoryId: data?.id as string,
        input: {
