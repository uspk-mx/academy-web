...
const getSortLabel = (sortBy: string) => {
  const labels: Record<string, string> = {
    ...
    draft: "Borradores primero",
  };
  return labels[sortBy] || labels.newest;
};

export const CoursesPageToolbar = ({
  isLoading,
  onSearch,
  hasPublishFilters,
  ctaLabel,
    ...
    <div className="flex items-center w-full gap-4">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          >
            <DropdownMenuRadioItem value="newest">Nuevos</DropdownMenuRadioItem>
            <DropdownMenuRadioItem value="oldest">Viejos</DropdownMenuRadioItem>
