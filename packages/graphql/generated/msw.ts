 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockSetCoursePrerequisitesMutation(
 *   ({ query, variables }) => {
 *     const { input } = variables;
 *     return HttpResponse.json({
 *       data: { setCoursePrerequisites }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockSetCoursePrerequisitesMutation = (resolver: GraphQLResponseResolver<SetCoursePrerequisitesMutation, SetCoursePrerequisitesMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<SetCoursePrerequisitesMutation, SetCoursePrerequisitesMutationVariables>(
 ...
 * )
 */
export const mockLearningPathsQuery = (resolver: GraphQLResponseResolver<LearningPathsQuery, LearningPathsQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<LearningPathsQuery, LearningPathsQueryVariables>(
    'LearningPaths',
    resolver,
    options
  )
 ...
 * )
 */
export const mockLearningPathQuery = (resolver: GraphQLResponseResolver<LearningPathQuery, LearningPathQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<LearningPathQuery, LearningPathQueryVariables>(
    'LearningPath',
    resolver,
    options
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockCreateLearningPathMutation(
 *   ({ query, variables }) => {
 *     const { input } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockCreateLearningPathMutation = (resolver: GraphQLResponseResolver<CreateLearningPathMutation, CreateLearningPathMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<CreateLearningPathMutation, CreateLearningPathMutationVariables>(
    'CreateLearningPath',
    resolver,
    options
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockUpdateLearningPathMutation(
 *   ({ query, variables }) => {
 *     const { learningPathId, input } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockUpdateLearningPathMutation = (resolver: GraphQLResponseResolver<UpdateLearningPathMutation, UpdateLearningPathMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<UpdateLearningPathMutation, UpdateLearningPathMutationVariables>(
    'UpdateLearningPath',
    resolver,
    options
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockDeleteLearningPathMutation(
 *   ({ query, variables }) => {
 *     const { learningPathId } = variables;
 *     return HttpResponse.json({
 *       data: { deleteLearningPath }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockDeleteLearningPathMutation = (resolver: GraphQLResponseResolver<DeleteLearningPathMutation, DeleteLearningPathMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<DeleteLearningPathMutation, DeleteLearningPathMutationVariables>(
    'DeleteLearningPath',
    resolver,
    options
  )
