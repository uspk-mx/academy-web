...
export function meta({ params }: Route.MetaArgs) {
  return [
    { title: `Uspk Academy | Detalles de orden: ${params.oid}` },
    { name: "description", content: "Detalles de orden, visualiza y administra los detalles de las órdenes de compra." },
  ];
}
