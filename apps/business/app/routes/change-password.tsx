...
import { UpdateUserPasswordDocument } from "gql-generated/gql/graphql";
import type {
...
const changePasswordSchema = z
  .object({
    currentPassword: z
      .string({
        message: "La contraseña actual es un campo requerido.",
      })
      .min(8, "La contraseña actual es un campo requerido"),
    newPassword: z
      .string({
        message: "La nueva contraseña es un campo requerido.",
      })
